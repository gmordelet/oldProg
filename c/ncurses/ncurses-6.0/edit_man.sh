...
(*.[0-9]*)
	...
	if test ! -f /users/licence/ib00895/oldProg/c/ncurses/ncurses-6.0/man_alias.sed ; then
cat >>/users/licence/ib00895/oldProg/c/ncurses/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /users/licence/ib00895/oldProg/c/ncurses/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /users/licence/ib00895/oldProg/c/ncurses/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /users/licence/ib00895/oldProg/c/ncurses/ncurses-6.0/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /users/licence/ib00895/oldProg/c/ncurses/ncurses-6.0/man_alias.sed \
		< $i | sed -f /users/licence/ib00895/oldProg/c/ncurses/ncurses-6.0/edit_man.sed >$TMP
